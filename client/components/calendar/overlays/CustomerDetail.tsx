...
import {StyledHeader, useDialogAccessibility, useLayerInstanceId} from './ModalStyles';
...
import {
    StyledCustomerOverlay, StyledCustomerDetail, StyledCustomerContent,
    StyledHeaderActions, StyledHeaderActionButton, StyledHeaderCloseButton,
    StyledInfo, StyledTelLink, StyledNoshowCount, StyledEditFields, StyledPointInfo,
    StyledAddressMemoSection, StyledAddressMemoList, StyledTagEditor, StyledTagInputRow,
    StyledColorRow, StyledAddressMemoItem, StyledTagRemoveButton, StyledEditError, StyledEmptyText,
    StyledPointHistorySection, StyledPointHistoryHeader, StyledPointHistoryMoreButton,
    StyledPointHistoryList, StyledPointHistoryItem, StyledPointHistoryTop, StyledPointHistoryMeta,
    StyledPointHistoryOverlay, StyledPointHistoryModal, StyledPointHistoryModalContent,
    StyledReservationSection, StyledReservationScroll, StyledMoreButton,
    StyledUnmergeOverlay, StyledUnmergeModal, StyledUnmergeContent,
    StyledUnmergeMessage, StyledUnmergeList, StyledUnmergeItem, StyledUnmergeFooter,
